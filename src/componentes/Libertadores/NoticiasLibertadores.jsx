        ...
        <div className="noticias-pagina-principal">
            <Link to={`/libertadores/${noticiaDestacada.id}`} className="noticia-destacada">
                ...
                <div className="noticia-destacada-info">
                    ...
                    <p className="nd-autor">
                        Por <span>{noticiaDestacada.autor}</span> ·{' '}
                        <span className="nd-fecha">{noticiaDestacada.fecha}</span>
                    </p>
                </div>
            </Link>
            ...
            <div className="noticias-secundarias-grid">
                {noticiasSecundarias.map((noticia) => (
                    <Link to={`/libertadores/${noticia.id}`} key={noticia.id} className="card-noticia-secundaria">
                        ...
                        <div className="card-secundaria-content">
                            ...
                            <div className="card-secundaria-footer">
                                ...
                                <p className="card-likes">
                                    <img
                                        src="https://cdn-icons-png.flaticon.com/128/18280/18280312.png"
                                        alt="like"
                                        className="like-icon"
                                    />{' '}
                                    {noticia.likes}
...
export default NoticiasLibertadores;
