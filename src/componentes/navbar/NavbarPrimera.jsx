      ...
      <div className='noticias-dia-primera'>
        {equipoSeleccionado ? (
          <>
            ...
            <button className='regresar-noticias-generales-primera' onClick={volverANoticiasGenerales}>Volver a noticias generales</button>
          </>
        ) : (
          <>
            <h2 className='noticia-del-dia-navbar-primera'>Noticia del día</h2>
            <p className='mini-noticia-primera'>⚽ Boca prepara su debut</p>
            <p className='mini-noticia-primera'>📢 River presenta nueva camiseta</p>
            <p className='mini-noticia-primera'>🔥 Clásico rosarino confirmado</p>
          </>
        )}
      </div>
