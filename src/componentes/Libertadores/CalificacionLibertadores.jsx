...
const CalificacionLibertadores = () => {
  ...
  const fases = ["grupo", "octavos de final", "cuartos de final", "semifinal", "final"];
  const datosFiltrados = faseLibertadores.filter(fase => fase.categoria === faseSeleccionada);

  return (
    <div className="libertadores">
      <img src="https://api.promiedos.com.ar/images/league/bac/1" alt="Libertadores" />
              ...
              <>
                ...
                <div className="tabla-posiciones">
                  <div className="fila encabezado">
                    <span className="col escudo"></span> {/* Escudo */}
                    <span className="col nombre">Equipo</span> {/* Nombre */}
                    <span>J</span>
                    <span>G</span>
                    <span>E</span>
                    <span>P</span>
                  ...
                  {[1, 2, 3, 4].map((n, index) => (
                    <div key={n} className={`fila ${index < 2 ? 'clasificado' : ''}`}>
                      ...
                      <span className="col nombre">{item[`nombre${n}`]}</span>
